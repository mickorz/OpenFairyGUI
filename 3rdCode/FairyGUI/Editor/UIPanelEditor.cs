...
namespace FairyGUIEditor
{
    ...
    public class UIPanelEditor : Editor
    {
        ...
        void OnSceneGUI()
        {
            ...
            var fmh_147_58_638512930209063379 = Quaternion.identity; 
            // Vector3 newPos = Handles.FreeMoveHandle(pos, sizeFactor, Vector3.one, Handles.ArrowHandleCap);
            var fmh_149_58_638699439139321663 = Quaternion.identity; Vector3 newPos = Handles.FreeMoveHandle(pos, sizeFactor, Vector3.one, Handles.ArrowHandleCap);
#else
